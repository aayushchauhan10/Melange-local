...
const ContentSolution = () => {
  return (
    <div className="max-container  lg:px-[96px] px-[20px] 2xl:mx-auto xxl:px-[156px] my-[50px] lg:my-[100px]">
      <div className=" relative">
        <div className="lg:flex justify-center items-start lg:space-x-[60px]">
          ...
          <div className="lg:-mt-0 mt-3">
            <div className="my-3 lg:my-0">
              ...
              <span className="text-zinc-900 lg:text-5xl text-3xl font-semibold font-nunito lg:leading-[56px]">
                Video Production Agency{" "}
              </span>
            </div>
            <div className=" text-black lg:text-lg  text-base font-normal font-nunito lg:mt-3 mt-3">
            ...
            <div className="text-black lg:text-lg text-base font-normal font-nunito lg:mt-2 mt-3">
        ...
        <img
          src={sqaureDots}
          alt=""
          className="absolute -bottom-[60px] -z-10 -left-10 lg:block hidden "
        />
      </div>
    </div>
  );
