  ...
  return (
    ...
    >
      <div className="lg:text-center text-zinc-900 lg:text-[40px] text-2xl font-semibold lg:leading-[48px] leading-[34px]">
        Want impactful content? Share your details here
      </div>
      <div className="lg:px-[15%] lg:text-center text-black lg:text-xl text-base font-normal lg:leading-[30px] mt-2">
        Our team will connect with you to understand your unique needs, budget,
        and desired outcomes, ensuring the delivery of content that drives
        results.
      </div>
      <form onSubmit={handleSubmit} ref={formField}>
        <div className=" max-container grid lg:grid-cols-2 grid-cols-1 lg:gap-6 lg:gap-y-6 gap-y-3 lg:mt-9 mt-6 lg:px-[8%]">
          <input
            ...
            className="w-full outline-none font-nunito lg:h-12 h-[39px] lg:rounded-none rounded bg-white p-3 text-[#6A6A68] placeholder-[#6A6A68]"
          />
          ...
          <select
            ...
            required
            className="w-full outline-none font-nunito lg:h-12 h-[39px] lg:rounded-none rounded bg-white px-2 text-[#6A6A68]"
          >
        ...
        <div className="flex justify-center items-center lg:mt-8 mt-[19px]">
          {loader ? (
            ...
            <button
              type="submit"
              className="lg:w-28 w-full h-11 px-[23px] py-0.5 bg-gradient-to-l submitBtn rounded-[100px] justify-center items-center gap-3 inline-flex font-nunito text-white text-xl font-semibold  leading-[35px]"
            >
              Submit
            </button>
          )}
      ...
      <div className=" lg:block hidden absolute top-[10%] left-[8%] animate-pulse">
        <img src={triBlue} alt="" />
      </div>
      <div className=" lg:block hidden absolute bottom-[10%] right-[10%] animate-pulse">
